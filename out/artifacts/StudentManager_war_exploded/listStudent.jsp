    ...
    <table class="table table-striped table-bordered table-hover table-condensed">
        ...
        <c:forEach items="${students}" var="s" varStatus="status">
            <tr>
                ...
                <td><a href="/StudentManager_war_exploded/editStudent?id=${s.id}"><span class="glyphicon glyphicon-edit"></span> </a></td>
                <td><a href="/StudentManager_war_exploded/deleteStudent?id=${s.id}" onclick="javascript:return del();"><span
...
<div class="addDIV">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <form method="post" id="addForm" action="/StudentManager_war_exploded/addStudent" role="form">
